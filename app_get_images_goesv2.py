...
def get_s3_keys(bucket, prefix = ''):
    ...
    print(prefix)
    s3 = boto3.client('s3',aws_access_key_id="AAAA",aws_secret_access_key="BBBB")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='This is a Unicamp Atlas script by Alison Vilela / Thais Rocha. (Errors are not yet logged.)',
        prog='unicamp-atlas',
...
def getimage(year, day, hour, outputpath, channel, crop):
    try:
        ...
        for key in keys:
            ...
            new_image = image.resize((255, 255), PIL.Image.LANCZOS)
